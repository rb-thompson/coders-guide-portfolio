    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 to-blue-700 text-gray-200">
      <div className="flex flex-col items-center justify-center pt-20 pb-6">
        ...
        >
          ...
          <Link href="/quests">
            <motion.div
              className="text-gray-100 text-lg tracking-wider font-semibold flex justify-center items-center space-x-2 transition-colors"
      ...
      <article className="grid grid-cols-1 md:grid-cols-4 justify-center gap-4 px-16 md:px-24 py-8">
            <section className="bg-black/80 p-4 rounded-lg shadow-md">
