      ...
      <article className="grid grid-cols-1 md:grid-cols-4 justify-center gap-6 px-8 md:px-12 py-4 max-w-screen-xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm md:text-md text-gray-200">Track progress & profile</p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm md:text-md text-gray-200">Unlock quests & rewards</p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm md:text-md text-gray-200">Rewards for each quest</p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm md:text-md text-gray-200">Grow as a developer</p>
          </div>
        </motion.section>
      </article>
    </div>
